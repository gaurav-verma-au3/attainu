...
class LinkedList {
    ...
    frequencyReverseAlt(root, k) {
        ...
        if (current != null) {
            current.next = this.frequencyReverseAlt(current.next, k)
        }
        return prev
    }
...
// list.head = list.reverseList(list.head, 2)
//console.log(list.isPalindrome(list.head))



list.head = list.frequencyReverseAlt(list.head, 3)
